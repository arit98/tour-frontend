...
const ExperienceSection = ({ title, btn }) => {
  return (
    <div className='flex md:flex-row flex-col items-center justify-between my-4 w-[73%] m-auto select-none'>
      ...
      <div className='flex items-center justify-between gap-12 mt-16'>
        ...
        <div className='flex md:flex-row flex-wrap m-auto md:ml-0 items-center justify-center gap-12'>
      ...
      <img draggable="false" width="500" height="500" src={ExperienceImg} alt="Experience" />
    </div>
  )
}
